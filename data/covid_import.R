...
# Preliminaries -----------------------------------------------------------
# Source https://m-clark.github.io/posts/2020-03-23-covid/

library(tidyverse) # required for functions
library(jsonlite)

setwd("C:/Users/zfi4/source/repos/d3/d3-in-angular/src/app/data")
...
counties = read_nyt_data(FALSE) 
jsonCounties <- toJSON(counties, pretty=FALSE)
write("{\"counties\":", file = "counties-historical.json", append = FALSE, sep = " ")
write(jsonCounties, file = "counties-historical.json",   append = TRUE, sep = " ")
write("}", file = "counties-historical.json", append = TRUE, sep = " ")


states = read_nyt_data(TRUE) 
jsonStates <- toJSON(states, pretty=FALSE)
write("{\"states\":", file = "states-historical.json", append = FALSE, sep = " ")
write(jsonStates, file = "states-historical.json",   append = TRUE, sep = " ")
write("}", file = "states-historical.json", append = TRUE, sep = " ")
